...
const cardsData = [
    ...
    { title: "命令助手↗", description: "便捷易用的命令辅助输入应用(遭受攻击，可能无法访问)", categories:["friend-links"], link: "https://ca.projectxero.top/", newtap:true },
    ...
    { title: "网易版导入", description: "限免活动中…站长自营无坑", categories:["resource"], link: "https://tool.lonzov.top/dr/pro", newtap:true },
